...
def play(conn, gameData):
    ...
    # Predefined Variables(Do not modify)gasdgawgawgwabadfhgsethjsetjr
    # TABLE_WIDTH = 254
    # TABLE_HEIGHT = 127
    # NUMBER_OF_BALLS = 6
    # HOLES = [[0, 0], [127, 0], [254, 0], [0, 127], [127, 127], [254, 127]]
    ...
    def calc_target_point(ball_x, ball_y, hole):
        ...
        if NEW_H[hole][0] > ball_x:
            ...
            if NEW_H[hole][1] < ball_y:
                ...
                x_increase = math.cos(radian)*5.72
                y_increase = -math.sin(radian)*5.72
        print(f'x_increa : {x_increase} y_increa : {y_increase}')
    ...
    print(f'hole : {target_hole}')
    print(angle)
    print(calc_target_point(targetBall_x, targetBall_y, target_hole)[0], calc_target_point(targetBall_x, targetBall_y, target_hole)[1])
    print(calc_angle(whiteBall_x, whiteBall_y, targetBall_x, targetBall_y))
